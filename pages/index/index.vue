		...
		<view class="info-box">
			<view class="white-box padding g-shop-info" @tap="toShop">
				<view class="u-flex u-row-between">
					...
					<view class="red fs0" @tap.stop="toShops()">更多门店 <text class="iconfont icon-arrow-right u-m-l-10"></text></view>
				</view>
				...
				<view class="u-flex u-row-between u-m-t-12 u-m-b-16">
					...
					<view class="g-flex u-m-l-30">
						<view class="g-flex iconfont icon-qrcode u-m-r-30" @tap.stop="lookQrCode()" v-if="currentShop.companyWeixinCode"></view>
						<view class="g-flex iconfont icon-location u-m-r-30" @tap.stop="lookMap()"></view>
						<view class="g-flex iconfont icon-phone" @tap.stop="phoneCall()" v-if="currentShop.relationPhone"></view>
					</view>
				</view>
